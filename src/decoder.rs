        ...
        for obu in iter_obus(data) {
            ...
            match obu.header.obu_type {
                ...
                ObuType::Frame => {
                    ...
                    // Round 45 (workspace task #776): coded_lossless
                    // frames now decode through the spec-correct
                    // §5.11.39 coefficient context derivation
                    // (`decode_coefficients_spec` polls per-plane
                    // Above/LeftLevelContext / DcContext arrays) plus
                    // the §7.7.4 inverse-WHT dispatch landed in round
                    // 44. The temporary `Error::Unsupported` guard
                    // that round 44 added at this site is removed.
                ...
                ObuType::TileGroup => {
                    ...
                    // Round 45 (workspace task #776): coded_lossless
                    // guard removed — see the OBU_FRAME branch above.
